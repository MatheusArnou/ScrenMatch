package primeirosPassos.Desafios.desafioHerancaEPolimorfismo.Carro;
...
public class Carro {
    ...
    public void exibirInfo() {
        ...
        System.out.println("Média do valor: " + calcularMediaPreco());
    }
    ...
    private double calcularMediaPreco(){
        int cont = 3;
        double media;

        media = (precoAno1+precoAno2+precoAno3)/cont;
        return media;
